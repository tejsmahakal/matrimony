...
const profileImage = data.profileImage || "/default-avatar.jpg";
...
// import React, { useState } from "react";
// import { useNavigate } from "react-router-dom";
// import { useSendInterestMutation } from "../../context/profileApi";
...
//   // ✅ USE IMAGE DIRECTLY FROM PROFILE RESPONSE
//   const profileImage = data.profileImage || "/default-avatar.jpg";
...
//               <FieldRow leftTitle="Full Name" leftValue={data.fullName} rightTitle="Gender" rightValue={data.gender} />
//               <FieldRow leftTitle="Caste" leftValue={data.caste} rightTitle="Age" rightValue={data.age} />
//               <FieldRow leftTitle="Marital Status" leftValue={data.maritalStatus} rightTitle="City" rightValue={data.taluka} />
//               <FieldRow leftTitle="Height" leftValue={data.height} rightTitle="Weight" rightValue={data.weight} />
//               <FieldRow leftTitle="Blood Group" leftValue={data.bloodGroup} rightTitle="Complexion" rightValue={data.complexion} />
